...
The sample dataset shipped in `data/` is **synthetic and entirely fictional** — generated by [`scripts/generate_sample_data.py`](scripts/generate_sample_data.py) purely so the pipeline can run end-to-end. It contains no real-world records of any kind.
