...
The sample dataset is **synthetic and entirely fictional** — generated by `drsm generate-sample-data` (module [`disaster_risk_score_model.sample_data`](src/disaster_risk_score_model/sample_data.py)) purely so the pipeline can run end-to-end. It contains no real-world records of any kind.
