                ...
                rows.append(
                    {
                        ...
                        # exposure
                        "sum_population": round(pop, 0),
                        "total_hhd": round(hhd, 0),
                        ...
                        "net_sown_area_in_hac": round(sown, 2),
                        "avg_electricity": round(electricity, 3),
                        "piped_water_hhds_pct": round(piped, 2),
                        "no_sanitation_hhds_pct": round(no_san, 2),
                        "sum_aged_population": round(aged, 0),
                        "flood_protection_failures": round(fp_failures, 2),
                        # vulnerability damage
                        "Human_Live_Lost": round(lives, 0),
                        "Population_affected_Total": round(affected, 0),
                        "Crop_Area": round(crop, 2),
                        "flood_protection_damaged": round(fp_damaged, 2),
                        "Roads": round(roads_dmg, 2),
                        "Bridge": round(bridge_dmg, 2),
                        # government response
